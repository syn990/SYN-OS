# ------------------------------------------------------------------------------
#                  S Y N  –  N E T C L I E N T   (Client)
#
#   Lightweight client utility for probing SYN‑NETSERVER endpoints and
...
#   Component     : SYN‑NETCLIENT (Client Utility)
...
print_banner() {
  ...
  print -P "${G}S Y N – N E T C L I E N T   ${Y}(Client)   ${N}|  ${C}Auto‑probe • Push/Pull menu%f"
  print -P ""
}
