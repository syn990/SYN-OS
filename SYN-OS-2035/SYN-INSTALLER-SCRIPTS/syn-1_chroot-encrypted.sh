...
# Fetch the UUID of the root partition
ROOT_PARTITION_UUID=$(blkid -s UUID -o value /dev/mapper/cryptroot)

echo "title   Arch Linux" > /boot/loader/entries/arch.conf
echo "linux   /vmlinuz-linux" >> /boot/loader/entries/arch.conf
echo "initrd  /initramfs-linux.img" >> /boot/loader/entries/arch.conf
echo "options cryptdevice=UUID=$ROOT_PARTITION_UUID:cryptroot root=/dev/mapper/cryptroot rw" >> /boot/loader/entries/arch.conf
