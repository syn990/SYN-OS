...
iso_application="SYN-RTOS-V4 Installation Enviroment"
iso_version="V4"
install_dir="arch"
buildmodes=('iso')
...
file_permissions=(
  ["/etc/shadow"]="0:0:400"
  ["/root"]="0:0:750"
  ["/root/syn-stage0.sh"]="0:0:750"
  ["/root/syn-stage1.sh"]="0:0:750"
  ...
  ["/root/SYN-TOOLS/equip-profile-with-repo.sh"]="0:0:750"
  ["/root/SYN-TOOLS/ShowInterfaceAddrLoop.sh"]="0:0:750"
  ["/root/SYN-TOOLS/REBUILD_ISO.sh"]="0:0:750"
)
