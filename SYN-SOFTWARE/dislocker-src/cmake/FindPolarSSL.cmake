...
# SYN-OS: Arch's default mbedtls is 4.x, which dropped the legacy AES/SHA
# API dislocker uses — prefer the mbedtls3 package's side-by-side
# install (/usr/include/mbedtls3, /usr/lib/mbedtls3) over it.
find_path(POLARSSL_INCLUDE_DIRS NAMES mbedtls/ssl.h HINTS /usr/include/mbedtls3 /usr/local/include)
...
#
find_library(POLARSSL_LIBRARIES NAMES mbedcrypto HINTS /usr/lib/mbedtls3)
