...
enum {
	...
	SYN_THEME_PAIR_URGENT, /* pal.urgent (red/alert) — failure/error text */
	SYN_THEME_PAIR_COUNT
};

/* Custom color slots 16-21 (0-15 stay the standard ANSI palette every
 ...
 * init_pair just become no-ops on such terminals). Slots 16-21 remain
